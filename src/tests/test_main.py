...
from tests.mocks import mock_household, mock_emissions, mock_opex, mock_upfront_cost
...
class TestCalculateHouseholdSavings(TestCase):
    ...
    def test_it_calls_calculate_emissions_correctly(
        self, mock_calculate_emissions, mock_calculate_opex, mock_calculate_upfront_cost
    ):
