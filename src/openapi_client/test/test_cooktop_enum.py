...
from openapi_client.models.cooktop_enum import CooktopEnum  # noqa: E501

class TestCooktopEnum(unittest.TestCase):
    """CooktopEnum unit test stubs"""
