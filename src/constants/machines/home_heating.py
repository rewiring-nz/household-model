...
# then dividing by reasonable-ish ratios based on the HOME_HEATING_REPLACEMENT_RATIOS
...
HOME_HEATING_ELECTRIC_TYPES = [
    k for k, v in HOME_HEATING_TYPE_TO_FUEL_TYPE.items() if v == 'electricity'
]
