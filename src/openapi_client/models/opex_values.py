...
class OpexValues(BaseModel):
    ...
    difference: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The difference in opex costs before & after electrification, in NZD to 2 dp.")
