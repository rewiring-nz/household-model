...
from savings.emissions.calculate_emissions import enrich_emissions
from savings.opex.calculate_opex import enrich_opex
from savings.upfront_cost.calculate_upfront_cost import enrich_upfront_cost
