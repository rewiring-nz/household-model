...
class Savings(BaseModel):
    ...
    upfront_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="upfrontCost", description="The estimated total NZD cost of electrifying the household")
    __properties = ["emissions", "opex", "upfrontCost"]
    ...
    def from_dict(cls, obj: dict) -> Savings:
        ...
        _obj = Savings.parse_obj({
            ...
            "upfront_cost": obj.get("upfrontCost")
        })
        return _obj
